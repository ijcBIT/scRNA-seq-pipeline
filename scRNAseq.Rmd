...
# Create Seurat object using the file path from params
seurat_obj <- load_and_create_seurat_object(params$file_10X_h5, project_name)

# Save the Seurat object or proceed with further analysis
